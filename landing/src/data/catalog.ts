...
export const vehicles: Vehicle[] = [
  {
    ...
    image: vehicleImage('/assets/mock/zeekr-001.webp', 'Mock editorial render of a white Zeekr 001 in a dark garage'),
  },
  {
    id: 'bmw-x5',
    make: 'BMW',
  ...
  },
  {
    ...
    image: vehicleImage('/assets/mock/li-auto-l7.webp', 'Mock editorial render of a light blue Li Auto L7 in a dark garage'),
  },
  {
    id: 'geely-cityray',
    make: 'Geely',
    ...
    generation: 'First generation',
    yearLabel: '2024—',
    displayName: 'Geely Cityray',
    bodyLabel: 'Urban crossover',
    image: vehicleImage('/assets/mock/geely-cityray.webp', 'Mock editorial reference image for a Geely Cityray'),
  },
];
...
export const wheels: Wheel[] = [
  {
    ...
    et: 35,
    dia: 67.1,
    thumbnail: { src: '/assets/mock/wheel-a.webp', width: 640, height: 640, alt: 'Mock satin graphite wheel, Aero 01' },
  },
  {
    id: 'wheel-b',
    brand: 'DW Studio',
    ...
    et: 40,
    dia: 66.6,
    thumbnail: { src: '/assets/mock/wheel-b.webp', width: 640, height: 640, alt: 'Mock brushed silver wheel, Mesh 02' },
  },
  {
    id: 'wheel-c',
    brand: 'DW Studio',
    ...
    et: 38,
    dia: 67.1,
    thumbnail: { src: '/assets/mock/wheel-c.webp', width: 640, height: 640, alt: 'Mock matte black wheel, Mono 03' },
  },
];
